...
Neko Agent 是一个开源的基于人工智能的 Windows 操作自动化工具，它能够接收用户的自然语言，将复杂任务分解为一系列精确的、可执行的小步骤，并通过模拟操作来自动完成这些任务，这是一个远古版本的命令行版本的Neko，不推荐安装，建议安装有更多新功能的GUI版本，最新图形化版本(在这里)[https://github.com/Lin-neko/neko_agent/tree/gui_dev]
