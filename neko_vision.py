...
class ScreenCapture:
    ...
    def grab_screen_base64(self,debug=0,log=True):
        ...
        new_width = int(self.original_width / self.magnification)
        new_height = int(self.original_height / self.magnification)
        ...
        if log == True :
            print("喵喵获取了屏幕截图")
        return img_str, (new_width, new_height,self.original_width, self.original_height)
